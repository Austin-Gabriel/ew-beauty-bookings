  ...
  return (
    ...
    >
      <span
        ...
        style={{ background: "linear-gradient(180deg, rgba(255,255,255,0.22) 0%, rgba(255,255,255,0) 60%)" }}
      />
...
export function SecondaryButton({
  ...
  return (
    <button
      type="button"
      {...rest}
      className={"w-full transition-all duration-300 active:scale-[0.98] disabled:opacity-50 " + (rest.className ?? "")}
      style={{
        height: 52,
        borderRadius: 9999,
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.backgroundColor = isDark ? "rgba(255,130,63,0.06)" : "rgba(255,130,63,0.08)";
      }}
      onMouseLeave={(e) => {
